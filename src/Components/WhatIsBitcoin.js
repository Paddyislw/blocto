...
export default function WhatIsBitcoin() {
  return (
    <div className='whatblock  pt-20 mt-32 mb-10'>
      ...
      <div className=' bg-[#081f19]  mt-10 flex items-center px-20 py-12 rounded-[250px] justify-between xl:px-12 md:flex-col md:px-0 '>
        ...
        <div className='text-white text-xl md:px-10 py-4'>          
          <p className=' md:px-1 text-center leading-8'>
